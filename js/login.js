...
$(document).on("click", ".btnlogin", function() {
        ...
        $.ajax({
            url: "http://129.151.104.63:8080/api/user/all" + usuarioLogin + "/" + usuarioPassword,
            type: "GET",
            datatype: "JSON",
...
function validarperfil(perfil) {
    switch (perfil) {
        case 'ADM':
            ...
            break;
        case 'COORD':
            console.log('Perfil Coord');
            window.location.href = "perfilCoord.html";
            break;
        case 'ASE':
            window.location.href = "Perfil Ase.html";
            console.log('Perfil Ase');
            break;
    }
